...
import (
	...
	go_micro_service_route "github.com/LCY2013/paas/route/proto/route"
	...
	"github.com/LCY2013/paas/routeapi/handler"
	hystrix2 "github.com/LCY2013/paas/routeapi/plugin/hystrix"
	...
	routeapi "github.com/LCY2013/paas/routeapi/proto/routeapi"
)
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.routeapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
