...
// Find{{title .Alias}}ByID 根据ID查找{{title .Alias}}信息
...
// Create{{title .Alias}} 创建{{title .Alias}}信息
...
// Delete{{title .Alias}}ByID 根据ID删除{{title .Alias}}信息
...
// Update{{title .Alias}} 更新{{title .Alias}}信息
...
// I{{title .Alias}}DataService 这里是接口类型
