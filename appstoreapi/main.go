...
import (
	go_micro_service_appstore "github.com/LCY2013/paas/appstore/proto/appstore"
	...
	"github.com/LCY2013/paas/appstoreapi/handler"
	hystrix2 "github.com/LCY2013/paas/appstoreapi/plugin/hystrix"
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.appstoreapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
