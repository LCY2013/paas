module github.com/LCY2013/paas/appstoreapi

go 1.20

require (
	github.com/LCY2013/paas/appstore v0.0.0-20230305101752-f09324978a31
	github.com/LCY2013/paas/common v0.0.0-20230304122114-17fb2d6a02c8
