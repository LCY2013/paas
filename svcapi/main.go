...
import (
	...
	go_micro_service_svc "github.com/LCY2013/paas/svc/proto/svc"
	...
	"github.com/LCY2013/paas/svcapi/handler"
	hystrix2 "github.com/LCY2013/paas/svcapi/plugin/hystrix"
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.svcapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
