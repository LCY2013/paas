...
import (
	...
	"github.com/LCY2013/paas/pod/domain/repository"
	"path/filepath"

	ds "github.com/LCY2013/paas/pod/domain/service"
	"github.com/LCY2013/paas/pod/handler"
	//"github.com/afex/hystrix-go/hystrix"
	"github.com/LCY2013/paas/pod/proto/pod"
...
func main() {
	...
	//4.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.service.pod", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
