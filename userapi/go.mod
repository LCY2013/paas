module github.com/LCY2013/paas/userapi

go 1.20

require (
	github.com/LCY2013/paas/common v0.0.0-20230305101752-f09324978a31
	github.com/LCY2013/paas/user v0.0.0-20230305143159-1e59bbf09eb1
