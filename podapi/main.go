...
import (
	...
	go_micro_service_pod "github.com/LCY2013/paas/pod/proto/pod"
	...
	"github.com/LCY2013/paas/podapi/handler"
	hystrix2 "github.com/LCY2013/paas/podapi/plugin/hystrix"
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.podapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
