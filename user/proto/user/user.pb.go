...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x22, 0x36, 0x0a, 0x07, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x09, 0x75,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x3c, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72,
	...
	0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x03, 0x28, 0x03, 0x52, 0x06,
	0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x3c, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x52, 0x69,
	0x67, 0x68, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x1f, 0x0a, 0x05, 0x52, 0x69, 0x67, 0x68, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x61,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xa8, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2b,
...
var file_proto_user_user_proto_goTypes = []interface{}{
	...
	(*UserRight)(nil), // 6: user.UserRight
	(*Right)(nil),     // 7: user.Right
}
var file_proto_user_user_proto_depIdxs = []int32{
	...
	5,  // 6: user.User.AddRole:input_type -> user.UserRole
	5,  // 7: user.User.UpdateRole:input_type -> user.UserRole
	5,  // 8: user.User.DeleteRole:input_type -> user.UserRole
	6,  // 9: user.User.IsRight:input_type -> user.UserRight
	3,  // 10: user.User.AddUser:output_type -> user.Response
	3,  // 11: user.User.DeleteUser:output_type -> user.Response
	3,  // 12: user.User.UpdateUser:output_type -> user.Response
	0,  // 13: user.User.FindUserByID:output_type -> user.UserInfo
	4,  // 14: user.User.FindAllUser:output_type -> user.AllUser
	3,  // 15: user.User.AddRole:output_type -> user.Response
	3,  // 16: user.User.UpdateRole:output_type -> user.Response
	3,  // 17: user.User.DeleteRole:output_type -> user.Response
	7,  // 18: user.User.IsRight:output_type -> user.Right
