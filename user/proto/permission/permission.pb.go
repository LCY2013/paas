...
type PermissionInfo struct {
	...
	PermissionStatus   string `protobuf:"bytes,5,opt,name=permission_status,json=permissionStatus,proto3" json:"permission_status,omitempty"`
}
...
func (x *PermissionInfo) GetPermissionStatus() string {
	if x != nil {
