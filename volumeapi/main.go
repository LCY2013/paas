...
import (
	...
	go_micro_service_volume "github.com/LCY2013/paas/volume/proto/volume"
	...
	"github.com/LCY2013/paas/volumeapi/handler"
	hystrix2 "github.com/LCY2013/paas/volumeapi/plugin/hystrix"
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.volumeapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
