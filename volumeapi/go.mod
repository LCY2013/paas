module github.com/LCY2013/paas/volumeapi

go 1.20

require (
	github.com/LCY2013/paas/common v0.0.0-20230304054316-b0de4cc69b1a
	github.com/LCY2013/paas/volume v0.0.0-20230305053134-9680d7fc4046
