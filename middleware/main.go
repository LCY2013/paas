...
import (
	...
	ds "github.com/LCY2013/paas/middleware/domain/service"
	"github.com/LCY2013/paas/middleware/handler"
...
func main() {
	...
	//4.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.service.middleware", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
