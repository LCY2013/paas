module github.com/LCY2013/paas/middlewareapi

go 1.20

require (
	github.com/LCY2013/paas/common v0.0.0-20230305053134-9680d7fc4046
	github.com/LCY2013/paas/middleware v0.0.0-20230305094441-eedb982e93ee
