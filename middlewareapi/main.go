...
import (
	...
	go_micro_service_middleware "github.com/LCY2013/paas/middleware/proto/middleware"
	...
	"github.com/LCY2013/paas/middlewareapi/handler"
	hystrix2 "github.com/LCY2013/paas/middlewareapi/plugin/hystrix"
	...
	middlewareapi "github.com/LCY2013/paas/middlewareapi/proto/middlewareapi"
)
...
func main() {
	...
	//2.添加链路追踪
	t, io, err := trace.NewTracer("go.micro.api.middlewareapi", tracerHost+":"+strconv.Itoa(tracerPort))
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
